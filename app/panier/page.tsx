            ...
            <div className="min-h-screen bg-white">
                ...
                <div className="pt-32 pb-20 px-4 sm:px-6 lg:px-8">
                    <div className="max-w-2xl mx-auto text-center">
                        <ShoppingBag
                            className="h-24 w-24 text-neutral-300 mx-auto mb-8"
                            strokeWidth={1}
                        />
                        ...
                        <Link href="/#menu">
                            <Button
                                size="lg"
                                className="bg-black hover:bg-red-600 text-white text-sm tracking-wider uppercase px-8 cursor-pointer"
                            >
                                Voir le menu
                            </Button>
                        </Link>
                    ...
                    <div className="grid lg:grid-cols-3 gap-8 ">
                        ...
                        <div className="lg:col-span-2 space-y-4">
                            {items.map((item) => (
                                <Card
                                    key={item.name}
                                    className="bg-white border-neutral-200 overflow-hidden rounded-none"
                                >
