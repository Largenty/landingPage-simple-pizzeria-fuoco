...
import { Flame, Pizza, Clock, Users, MapPin, Phone, Mail } from "lucide-react";
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden md:flex items-center gap-12">
              <a href="#menu" className="text-neutral-700 hover:text-black transition-colors text-sm tracking-wide uppercase">
                Menu
              </a>
              <a href="#about" className="text-neutral-700 hover:text-black transition-colors text-sm tracking-wide uppercase">
                À propos
              </a>
              <a href="#contact" className="text-neutral-700 hover:text-black transition-colors text-sm tracking-wide uppercase">
                Contact
              </a>
              <Button className="bg-black hover:bg-neutral-800 text-white text-sm tracking-wide uppercase px-6">
                Réserver
              </Button>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-0">
            ...
            <div className="px-8 sm:px-12 lg:px-16 py-20 lg:py-32 flex flex-col justify-center">
              <div className="inline-block px-4 py-1.5 border border-black mb-8">
                <span className="text-black text-xs font-light tracking-widest uppercase">Napoli dal 1950</span>
              </div>
              <h1 className="text-6xl md:text-8xl font-light leading-none mb-8 tracking-tight">
                <span className="text-black">L'Arte</span>
                <br />
                <span className="text-black font-medium">Napoletana</span>
              </h1>
              <p className="text-lg text-neutral-600 leading-relaxed mb-12 max-w-md font-light">
                L'authenticité d'une tradition séculaire.
                Chaque pizza est façonnée à la main et cuite au feu de bois
                selon les règles strictes de l'école napolitaine.
              </p>
              <div className="flex flex-wrap gap-4 mb-12">
                <Button size="lg" className="bg-black hover:bg-neutral-800 text-white text-sm tracking-wider uppercase px-8">
                  Commander
                </Button>
                <Button
                  size="lg"
              ...
              <div className="flex gap-12 pt-4 border-t border-neutral-200">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-neutral-700 text-sm font-light">90 secondes</span>
                </div>
                <div className="flex items-center gap-3">
                  <Flame className="h-4 w-4 text-black" strokeWidth={1.5} />
                  <span className="text-neutral-700 text-sm font-light">485°C</span>
                </div>
                <div className="flex items-center gap-3">
                  <Pizza className="h-4 w-4 text-black" strokeWidth={1.5} />
                  <span className="text-neutral-700 text-sm font-light">Tradition</span>
                </div>
              </div>
            </div>
      ...
      {/* Menu Section */}
      <section id="menu" className="py-24 px-4 sm:px-6 lg:px-8 bg-neutral-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <div className="inline-block px-4 py-1.5 border border-black mb-6">
              <span className="text-black text-xs font-light tracking-widest uppercase">Le Menu</span>
            </div>
            ...
            <p className="text-lg text-neutral-600 font-light max-w-2xl mx-auto">
              ...
              avec une pâte fermentée 48h et des ingrédients d'exception
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {pizzas.map((pizza, index) => (
              <Card
                key={index}
                className="bg-white border-neutral-200 hover:border-black transition-all duration-500 group overflow-hidden"
              >
                ...
                <CardContent className="p-6">
                  <div className="flex justify-between items-start mb-4">
                    ...
                    <span className="text-xl font-light text-black">{pizza.price}</span>
                  </div>
                  <p className="text-neutral-600 mb-6 font-light text-sm leading-relaxed">{pizza.desc}</p>
                  <Button className="w-full bg-black hover:bg-neutral-800 text-white text-xs tracking-widest uppercase">
                    Commander
                  </Button>
                </CardContent>
              </Card>
      ...
      <section id="about" className="py-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <div className="inline-block px-4 py-1.5 border border-black mb-6">
              <span className="text-black text-xs font-light tracking-widest uppercase">Notre Savoir-Faire</span>
            </div>
            ...
            {[
              ...
              <div key={index} className="text-center group">
                <div className="inline-flex items-center justify-center w-20 h-20 border border-black mb-8 group-hover:bg-black transition-colors duration-300">
                  <feature.icon className="h-8 w-8 text-black group-hover:text-white transition-colors" strokeWidth={1.5} />
                </div>
                <h3 className="text-2xl font-light text-black mb-4 tracking-wide">{feature.title}</h3>
                <p className="text-neutral-600 font-light leading-relaxed">{feature.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section id="contact" className="py-24 px-4 sm:px-6 lg:px-8 bg-neutral-50">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            <div className="inline-block px-4 py-1.5 border border-black mb-6">
              <span className="text-black text-xs font-light tracking-widest uppercase">Contact</span>
            </div>
            <h2 className="text-5xl md:text-6xl font-light text-black mb-6 tracking-tight">
              Venez Nous Voir
            </h2>
          ...
          <div className="grid md:grid-cols-3 gap-12 mb-16">
            <div className="flex flex-col items-center text-center">
              <div className="inline-flex items-center justify-center w-14 h-14 border border-black mb-4">
                <MapPin className="h-5 w-5 text-black" strokeWidth={1.5} />
              </div>
              <h3 className="text-sm font-medium text-black mb-2 tracking-widest uppercase">Adresse</h3>
              <p className="text-neutral-600 font-light text-sm">123 Rue de la Pizza<br />75001 Paris</p>
            </div>
            <div className="flex flex-col items-center text-center">
              <div className="inline-flex items-center justify-center w-14 h-14 border border-black mb-4">
                <Phone className="h-5 w-5 text-black" strokeWidth={1.5} />
              </div>
              <h3 className="text-sm font-medium text-black mb-2 tracking-widest uppercase">Téléphone</h3>
              <p className="text-neutral-600 font-light text-sm">+33 1 23 45 67 89</p>
            </div>
            <div className="flex flex-col items-center text-center">
              <div className="inline-flex items-center justify-center w-14 h-14 border border-black mb-4">
                <Mail className="h-5 w-5 text-black" strokeWidth={1.5} />
              </div>
              <h3 className="text-sm font-medium text-black mb-2 tracking-widest uppercase">Email</h3>
              <p className="text-neutral-600 font-light text-sm">contact@pizzeriafuoco.fr</p>
            </div>
          </div>
          <div className="text-center">
            <Button size="lg" className="bg-black hover:bg-neutral-800 text-white text-sm tracking-widest uppercase px-12">
              Réserver une table
            </Button>
          </div>
        </div>
      ...
      <footer className="py-12 px-4 sm:px-6 lg:px-8 border-t border-neutral-200">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <div className="flex items-center gap-2">
              <Flame className="h-6 w-6 text-black" strokeWidth={1.5} />
            ...
            <div className="flex gap-8">
              <a href="#" className="text-neutral-600 hover:text-black transition-colors text-sm tracking-wide uppercase">
                Instagram
              </a>
              <a href="#" className="text-neutral-600 hover:text-black transition-colors text-sm tracking-wide uppercase">
                Facebook
